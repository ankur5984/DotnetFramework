...
namespace DAL
{
    ...
    public class MySqlDbManager : IManager
    {
        ...
        */
        ...
        public string conString = ConfigurationManager.ConnectionStrings["mysqlconnection"].ConnectionString;
        ...
        public bool UpdateProduct(Product product)
        {
            ...
            MySqlCommand command = new MySqlCommand(query, con);
            command.Parameters.Add(new MySqlParameter("@product_id", product.Id));
            command.Parameters.Add(new MySqlParameter("@product_name", product.Title));
            command.Parameters.Add(new MySqlParameter("@product_price", product.Price));
            command.Parameters.Add(new MySqlParameter("@product_quantity", product.Quantity));
        ...
        /*   for userauthentication table for User */
        ...
        public bool RegisterUser(User newUser)
        {
            ...
            cmd.Parameters.Add(new MySqlParameter("@user_name", newUser.UserName));
            cmd.Parameters.Add(new MySqlParameter("@password", newUser.Password));
            cmd.Parameters.Add(new MySqlParameter("@confirm_password", newUser.ConfirmPassword));
            try
            {
                //openning the connection
                con.Open();
